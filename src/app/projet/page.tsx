...
const Infographic = () => {
  ...
  return (
    <div className="relative w-full flex flex-col items-center overflow-hidden">
      <div className="relative w-full max-w-7xl mx-auto select-none flex items-center justify-start min-h-[450px] md:min-h-[750px] scale-[0.42] md:scale-[0.8] lg:scale-[0.85] origin-left -ml-24 md:ml-0 md:origin-center md:justify-center">
...
export default function Projet() {
  return (
    <div className="flex flex-col">
      ...
      {/* Conclusion Section */}
      <SectionWrapper className="bg-[#244D2F] text-white text-center [&>div]:py-6 md:[&>div]:py-14">
        <div className="max-w-4xl mx-auto space-y-4">
          <h2 className="text-3xl md:text-5xl font-serif leading-tight">
            Un modèle maîtrisé, un marché réel, une ambition structurée
          </h2>
          <div className="space-y-2 text-xl md:text-2xl font-light opacity-90 leading-relaxed max-w-3xl mx-auto">
            <p>
